...
#include "G4IonPhysicsXS.hh"  //SF
#include "G4IonQMDPhysics.hh"  //SF
#include "G4IonPhysicsPHP.hh"  //SF
#include "G4IonINCLXXPhysics.hh"  //SF
//****************************************
#include "G4DecayPhysics.hh"
...
void HadrontherapyPhysicsList::AddPhysicsList(const G4String& name)
{
    ...
    // SF *************************************************************
            ...
            // ION PHYSICS*************************************************************
            hadronPhys.push_back(new G4IonElasticPhysics());  // Ion Elastic scattering
            //hadronPhys.push_back( new G4IonBinaryCascadePhysics());// Ion Inelastic physics
            //hadronPhys.push_back( new G4IonINCLXXPhysics()); // Ion Inelastic physics
            hadronPhys.push_back( new G4IonPhysicsPHP()); // Ion Inelastic physics
            //hadronPhys.push_back( new G4IonQMDPhysics()); // Ion Inelastic physics
            //hadronPhys.push_back( new G4IonPhysicsXS()); // Ion Inelastic physic
            // *************************************************************************
