...
void PassiveCarbonBeamLine::SetDefaultDimensions()
{
    ...
    rippleFilterBoxMaterial = airNist; // SF
...
void PassiveCarbonBeamLine::ConstructPassiveCarbonBeamLine()
{
  ...
  //  HadrontherapyRippleFilter(); // to comment or not in order to have the FE peak or the SOBP respectively (C12)


//    StopperCostruction();


    HadrontherapyRidgeFilter();  // to comment or not in order to have the FE peak or the SOBP respectively (He4 e O16)
}
...
void PassiveCarbonBeamLine::HadrontherapyRippleFilter()
{
    ...
    //G4double defaultRippleFilterXPosition = -1638.0*mm; // SF Comment: WRONG
    //G4double defaultRippleFilterXPosition = -1588.0*mm; // SF : correct for C12
    G4double defaultRippleFilterXPosition = -1558.0*mm; // SF : correct for He4 MITRA
  ...
  /*  PhysiRippleFilter = new G4PVPlacement(G4Transform3D(rot,G4ThreeVector(ripple_position + 10*cm,0,0)),
                                          ...
                                          false,
                                          2,
                                          true);*/  // to be commented for MITRA8

    LogicRippleFilter -> SetVisAttributes(G4VisAttributes::Invisible);
   // LogicRippleFilter -> SetVisAttributes(red);
    ...
    PhysiRippleFilterBase = new G4PVPlacement(0,
                                              ...
                                              "PhysiRippleFilterBase", // SF : chaqnged from "PhysiRippleFilter" to "PhysiRippleFilterBase"
                                              LogicRippleFilterBase,
                                              PhysiRippleFilter,
                                              false,
                                              0,
...
void PassiveCarbonBeamLine::HadrontherapyBeamMonitoring()
{
    ...
    logicFirstMonitorLayer3 -> SetVisAttributes(gray); // SERENA
